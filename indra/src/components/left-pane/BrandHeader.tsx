    ...
    <div className="px-3 pt-3 pb-2 border-b border-zinc-800/50">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2.5">
          <div className="w-12 h-12 rounded-xl bg-zinc-900/90 border border-zinc-800/80 p-1 flex items-center justify-center flex-shrink-0 shadow-md relative group">
            <img 
              src="/logo.png" 
              alt="INDRA Logo" 
          ...
          <div>
            <div className="flex items-center gap-1.5">
              <span className="text-base font-bold tracking-[0.22em] text-zinc-100 font-mono">INDRA</span>
            </div>
