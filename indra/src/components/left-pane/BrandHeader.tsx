    ...
    <div className="px-3 pt-3 pb-2 border-b border-zinc-800/50">
      ...
      <div className="flex items-center justify-between mb-3.5">
        <div className="flex items-center gap-3">
          <div className="w-16 h-16 rounded-2xl bg-zinc-900 border border-zinc-800/80 p-1.5 flex items-center justify-center flex-shrink-0 shadow-lg relative group">
            <img 
              src="/logo.png" 
              alt="INDRA Logo" 
          ...
          <div>
            <div className="flex items-center gap-1.5">
              <span className="text-lg font-bold tracking-[0.22em] text-zinc-100 font-mono">INDRA</span>
            </div>
            <div className="text-[10px] text-zinc-400 font-mono tracking-wider">SOVEREIGN AI</div>
            <div className="inline-flex items-center gap-1 text-[9px] font-medium tracking-wider uppercase bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 rounded px-1.5 py-0.2 mt-1 font-mono">
